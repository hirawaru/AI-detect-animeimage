...
- Sau 5 epochs đầu, mô hình đạt val_accuracy = 73.06%, cho thấy khả năng học tốt.
- Kết quả sau khi train đủ số epoch: [Sinh viên điền - Accuracy, F1-Score, ROC-AUC trên test set].
